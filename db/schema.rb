...
ActiveRecord::Schema.define(version: 2021_03_24_135801) do

  create_table "t_witter_accounts", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_t_witter_accounts_on_user_id"
  end
  ...
  add_foreign_key "t_witter_accounts", "users"
